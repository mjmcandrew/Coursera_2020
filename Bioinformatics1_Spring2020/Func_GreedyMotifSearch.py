def MotifConsensus(Motifs):
    ...
    #count at each position of each motif. These values (?)
    consensus = ""
...
def GreedyMotifSearch(Dna, k, t):
    ...
    for index in range(n-k+1):
        ...
        #be stored.
        initial_pattern = Dna[0][index:index+k]
        Motifs.append(initial_pattern)
        ...
        for string in range(1, t):
            ...
            motif_profile = MotifProfile(Motifs[0:string])   #[0:string])
